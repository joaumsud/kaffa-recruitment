...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { done: @tarefa.done, title: @tarefa.title } }, as: :json
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { done: @tarefa.done, title: @tarefa.title } }, as: :json
    assert_response 200
  end
